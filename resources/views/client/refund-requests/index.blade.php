<x-app-layout>
    ...
    <div class="py-20 text-center">
        <div class="max-w-md mx-auto">
            ...
            <h2 class="text-2xl font-black text-slate-900 uppercase tracking-tighter">Refunds Module Incoming</h2>
            <p class="mt-2 text-slate-500 font-medium">Our financial department is currently upgrading the refund engine. This module will return once calibration is complete.</p>
        </div>
    </div>
    @endfeatureVisible
</x-app-layout>
