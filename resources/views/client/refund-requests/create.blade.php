<x-app-layout>
    ...
    <div class="py-20 text-center">
        <div class="max-w-md mx-auto">
            ...
            <h2 class="text-2xl font-black text-slate-900 uppercase tracking-tighter">Refund Submissions Locked</h2>
            <p class="mt-2 text-slate-500 font-medium">New refund claims are temporarily disabled while we update our processing protocols. Your existing claims are still being processed.</p>
        </div>
    </div>
    @endfeatureVisible
</x-app-layout>
