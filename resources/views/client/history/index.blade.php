            ...
            @else
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400 mt-0.5">
                                            <span class="font-semibold text-[#EF7722]">{{ $timeline->count() }}</span> {{ Str::plural(__('event'), $timeline->count()) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white dark:bg-slate-800 shadow-sm rounded-lg border border-[#EBEBEB] dark:border-slate-700 overflow-hidden">
                    <div class="p-6">
                        <div class="relative">
                            {{-- Vertical line --}}
                            <div class="absolute left-6 top-0 bottom-0 w-0.5 bg-[#EBEBEB] dark:bg-slate-700"></div>
                            
                            <div class="space-y-6">
                                @foreach($timeline as $index => $event)
                                    <div class="relative flex items-start gap-4 group">
                                        {{-- Timeline dot --}}
                                        <div class="relative z-10 flex items-center justify-center w-12 h-12 bg-[#EF7722] rounded-lg shadow-lg flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                                        ...
                                        {{-- Event card --}}
                                        <div class="flex-1 p-5 bg-[#EBEBEB] dark:bg-slate-900/50 hover:bg-[#EF7722]/5 dark:hover:bg-slate-700/50 border border-[#EBEBEB] dark:border-slate-700 hover:border-[#EF7722] dark:hover:border-[#EF7722] rounded-lg transition-all duration-200 group-hover:shadow-md">
                                            <div class="flex items-start justify-between mb-3">
                                                ...
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-[#EF7722] bg-[#EF7722]/10 rounded-lg border border-[#EF7722]/20">
                                            ...
                                            @if(isset($event['metadata']))
                                                <div class="flex flex-wrap items-center gap-2 mt-4 pt-4 border-t border-[#EBEBEB] dark:border-slate-700">
