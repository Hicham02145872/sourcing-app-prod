                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">{{ __('Share your product details and we\'ll handle the rest') }}</p>
                        </div>
                    </div>
                </div>
                <a href="{{ route('client.dashboard') }}" 
                   class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-all duration-200 shadow-sm w-full sm:w-auto justify-center">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label class="relative flex items-center p-3 border-2 border-[#EBEBEB] dark:border-slate-600 rounded-lg cursor-pointer hover:border-[#EF7722] dark:hover:border-[#EF7722] transition-all has-[:checked]:border-[#EF7722] has-[:checked]:bg-[#EF7722]/5 has-[:checked]:shadow-sm">
                                    <input type="radio" id="shipping_method_air" name="shipping_method" value="air" class="sr-only" {{ old('shipping_method') == 'air' ? 'checked' : '' }}>
                                ...
                                <label class="relative flex items-center p-3 border-2 border-[#EBEBEB] dark:border-slate-600 rounded-lg cursor-pointer hover:border-[#EF7722] dark:hover:border-[#EF7722] transition-all has-[:checked]:border-[#EF7722] has-[:checked]:bg-[#EF7722]/5 has-[:checked]:shadow-sm">
                                    <input type="radio" id="shipping_method_sea" name="shipping_method" value="sea" class="sr-only" {{ old('shipping_method') == 'sea' ? 'checked' : '' }}>
                                    <div class="flex items-center gap-2 w-full">
                                        <svg class="w-5 h-5 text-[#EF7722] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
