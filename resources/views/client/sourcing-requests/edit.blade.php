                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">{{ __('Update your product sourcing details and requirements') }}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-4">
            <form method="POST" action="{{ route('client.sourcing-requests.update', $sourcingRequest) }}" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                        <div class="flex items-center justify-between max-w-3xl mx-auto">
                            ...
                            <!-- Connector -->
                            <div class="flex-1 h-1 bg-blue-600 mx-4 rounded-full"></div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="hidden sm:block">
                                    ...
                                    <p class="text-xs text-slate-500 dark:text-slate-400">{{ __('Visual reference') }}</p>
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                            <div class="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">{{ __('Essential product information and requirements') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6 space-y-6">
                                <!-- Product Name -->
                                <div>
                                    <x-input-label for="product_name" class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                                        {{ __('Product Name') }} <span class="text-red-500">*</span>
                                    </x-input-label>
                                    <x-text-input id="product_name" 
                                                  class="block w-full rounded-lg border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:bg-slate-700 dark:text-white" 
                                                  type="text" 
                                                  name="product_name" 
                                ...
                                <!-- Product URL -->
                                <div>
                                    <x-input-label for="product_url" class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <!-- Category -->
                                    <div>
                                        <x-input-label for="category_id" class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                                            {{ __('Category') }} <span class="text-red-500">*</span>
                                        </x-input-label>
                                        <select id="category_id" 
                                                name="category_id" 
                                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 text-slate-900 dark:text-white shadow-sm dark:bg-slate-700" 
                                                required>
                                    ...
                                    <!-- Sourcing Location -->
                                    <div>
                                        <x-input-label for="sourcing_location" class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                                ...
                                <!-- Note -->
                                <div>
                                    <x-input-label for="note" class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                                        {{ __('Additional Notes / Specific Requirements') }}
                                    </x-input-label>
                                    <textarea id="note" 
                                              rows="4" 
                                              class="block w-full rounded-lg border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 resize-none shadow-sm dark:bg-slate-700 dark:text-white" 
                                              name="note" 
                                ...
                                <!-- Shipping Method -->
                                <div>
                                    <x-input-label class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 flex items-center gap-2">
                                        {{ __('Shipping Method') }}
                                    </x-input-label>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600 has-[:checked]:border-blue-500 dark:has-[:checked]:border-blue-400 has-[:checked]:bg-blue-50 dark:has-[:checked]:bg-blue-900/20 has-[:checked]:shadow-sm group border-slate-300 dark:border-slate-600">
                            ...
                            <div class="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">{{ __('Visual reference for sourcing team') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <div class="space-y-4">
                                    ...
                                    <label for="product_image" class="block cursor-pointer">
                                        <div class="flex items-center justify-center gap-2 px-5 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-lg text-sm font-bold transition-all duration-200 shadow-sm hover:shadow">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">{{ __('Where and how much') }}</p>
                                        </div>
                                    </div>
                                    <button type="button" 
                                            id="add-destination" 
                                            class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white text-sm font-bold rounded-lg shadow-sm hover:shadow transition-all duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @foreach ($sourcingRequest->destinations as $index => $destination)
                                        <div class="destination-block p-4 bg-slate-50 dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-600 transition-colors">
                                            <div class="space-y-4">
                                                <!-- Quantity -->
                                                <div>
                                                    <label for="destinations_{{ $index }}_quantity" class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-wide">{{ __('Quantity') }}</label>
                                                    <x-text-input type="number" 
                                                                  ...
                                                                  required 
                                                                  min="1" 
                                                                  class="w-full rounded-lg shadow-sm dark:bg-slate-800 dark:text-white border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500" 
                                                ...
                                                <!-- Country -->
                                                <div>
                                                    <label for="destinations_{{ $index }}_country_id" class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-wide">{{ __('Country') }}</label>
                                                    <select id="destinations_{{ $index }}_country_id"
                                                            name="destinations[{{ $index }}][country_id]" 
                                                            required 
                                                            class="block w-full rounded-lg border-slate-300 dark:border-slate-600 focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:bg-slate-800 dark:text-white">
                                                ...
                                                <!-- Service -->
                                                <div>
                                                    <label for="destinations_{{ $index }}_service_id" class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2 uppercase tracking-wide">{{ __('Service') }}</label>
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <button type="button" 
                                                            class="remove-destination w-full px-4 py-2.5 text-red-600 dark:text-red-400 hover:text-white hover:bg-red-600 border border-red-300 dark:border-red-700 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm text-sm font-semibold">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-8 flex flex-col sm:flex-row items-center justify-end gap-4 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 px-6 py-5">
                    <a href="{{ route('client.sourcing-requests.show', $sourcingRequest) }}" 
                       class="w-full sm:w-auto text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors duration-200 flex items-center justify-center gap-2 py-2.5">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="submit" 
                            class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white text-sm font-bold rounded-lg shadow-sm transition-all duration-200 hover:shadow focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-700/50">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
