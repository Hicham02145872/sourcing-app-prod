...
<head>
    ...
    <title>Invoice - Order #{{ $sourcingOrder->id }}</title>
    ...
    <div class="max-w-4xl mx-auto my-12 bg-white shadow-2xl">
        ...
        <div class="enterprise-header text-white p-10">
            <div class="flex justify-between items-start">
                <div>
                    <div class="text-5xl font-bold mb-2">INVOICE</div>
                    <div class="text-blue-200 text-sm font-medium tracking-wider">COMMERCIAL INVOICE</div>
                </div>
                <div class="text-right">
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm px-6 py-4 rounded-lg border border-white border-opacity-30">
                        <div class="text-xs text-blue-200 mb-1 uppercase tracking-wide">Invoice Number</div>
                        <div class="text-2xl font-bold">#{{ $sourcingOrder->id }}</div>
                        <div class="text-xs text-blue-200 mt-3 uppercase tracking-wide">Date Issued</div>
        ...
        <div class="p-10">
            <div class="grid grid-cols-2 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <div class="text-xl font-bold text-gray-900">Your Company Name</div>
                        <div class="text-sm text-gray-600">123 Business Avenue, Suite 100</div>
                        <div class="text-sm text-gray-600">New York, NY 10001</div>
                        <div class="text-sm text-gray-600 mt-3">
                            <span class="font-semibold">Email:</span> contact@yourcompany.com
                        </div>
                        <div class="text-sm text-gray-600">
                            <span class="font-semibold">Phone:</span> +1 (555) 123-4567
                        </div>
                        <div class="text-sm text-gray-600">
                            <span class="font-semibold">Tax ID:</span> XX-XXXXXXX
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="text-sm text-gray-600 mt-3">
                            <span class="font-semibold">Email:</span> {{ $sourcingOrder->user->email }}
                        </div>
                        <div class="text-sm text-gray-600">
                            <span class="font-semibold">Customer ID:</span> {{ $sourcingOrder->user->id }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-100 border-b-2 border-gray-300">
                            <th class="text-left p-4 text-xs font-bold text-gray-700 uppercase tracking-wider">Description</th>
                            <th class="text-center p-4 text-xs font-bold text-gray-700 uppercase tracking-wider">Quantity</th>
                            <th class="text-right p-4 text-xs font-bold text-gray-700 uppercase tracking-wider">Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="border-b border-gray-200">
                            <td class="p-4">
                                ...
                                <div class="text-xs text-gray-500 mt-1">Order Reference: #{{ $sourcingOrder->id }}</div>
                            </td>
            ...
            <div class="border-t-2 border-gray-200 pt-8 grid grid-cols-2 gap-8">
                <div>
                    <div class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Payment Terms</div>
                ...
                <div>
                    <div class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Notes</div>
                    <div class="text-sm text-gray-600">
                        Thank you for your business. For any inquiries regarding this invoice, please contact our accounts department.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-50 px-10 py-6 border-t border-gray-200">
            <div class="flex justify-between items-center text-xs text-gray-500">
                <div>
                    © {{ now()->format('Y') }} Your Company Name. All rights reserved.
                </div>
                <div class="text-right">
