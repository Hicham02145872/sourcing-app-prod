                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <nav class="flex text-xs text-slate-500" aria-label="Breadcrumb">
                                ...
                                <span class="mx-1.5">/</span>
                                <span class="font-medium text-slate-700">{{ $country->name }}</span>
                            </nav>
                        </div>
                    </div>
                ...
                <form method="POST" action="{{ route('admin.countries.update', $country) }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="name" :value="old('name', $country->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="code" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="code" :value="old('code', $country->code)" required maxlength="2" />
