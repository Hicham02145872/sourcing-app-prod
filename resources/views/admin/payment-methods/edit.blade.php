    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="p-3 bg-amber-600 rounded-lg shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('Update payment method information') }}</p>
                </div>
            </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div id="logo-preview" class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center overflow-hidden">
                                                    @if($paymentMethod->logo)
                                                        <img src="{{ asset('storage/' . $paymentMethod->logo) }}" alt="{{ $paymentMethod->name }}" class="w-full h-full object-contain">
                                                    @else
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input id="account_holder" 
                                               type="text" 
                                               name="account_holder" 
                                               value="{{ old('account_holder', $paymentMethod->details['Account Holder'] ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input id="account_number" 
                                               type="text" 
                                               name="account_number" 
                                               value="{{ old('account_number', $paymentMethod->details['Account Number'] ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input id="routing_number" 
                                               type="text" 
                                               name="routing_number" 
                                               value="{{ old('routing_number', $paymentMethod->details['Routing Number'] ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input id="bank_name" 
                                               type="text" 
                                               name="bank_name" 
                                               value="{{ old('bank_name', $paymentMethod->details['Bank Name'] ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input id="swift_code" 
                                               type="text" 
                                               name="swift_code" 
                                               value="{{ old('swift_code', $paymentMethod->details['SWIFT Code'] ?? '') }}"
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h4 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('Current Logo') }}</h4>
                                </div>
                                
                                <div class="flex items-center justify-center p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                    <img src="{{ asset('storage/' . $paymentMethod->logo) }}" alt="{{ $paymentMethod->name }}" class="max-w-full h-24 object-contain">
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <button type="submit" 
                                            class="w-full py-3 px-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-2">
                        ...
                        {{-- Help Card --}}
                        <div class="bg-amber-50 dark:bg-amber-900/50 rounded-lg border border-amber-100 dark:border-amber-900 p-6">
                            <div class="flex items-start gap-3">
                                <svg class="w-5 h-5 text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <div>
                                    <h5 class="text-sm font-semibold text-amber-900 dark:text-amber-300 mb-1">{{ __('Update Tips') }}</h5>
                                    <ul class="text-xs text-amber-700 dark:text-amber-400 space-y-1">
                                        <li>• {{ __('Review all details carefully') }}</li>
                                        <li>• {{ __('Upload new logo if needed') }}</li>
                                        <li>• {{ __('Verify account information') }}</li>
                                        <li>• {{ __('Check active status') }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
