            ...
            <form method="POST" action="{{ route('admin.payment-methods.update', $paymentMethod) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                                    ...
                                    <label for="is_active" class="flex items-center cursor-pointer group">
                                        <div class="relative">
                                            <input id="is_active" 
                                                   ...
                                                   class="sr-only peer">
                                            <div class="w-11 h-6 bg-slate-200 dark:bg-slate-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#EF7722]/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#EF7722]"></div>
                                        </div>
                        ...
                        {{-- HELP CARD --}}
                        <div class="bg-[#EF7722]/5 rounded-lg border border-[#EF7722]/20 p-5">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <h5 class="text-sm font-bold text-slate-900 dark:text-white mb-2">{{ __('Update Tips') }}</h5>
                                    <ul class="text-xs text-slate-700 dark:text-slate-400 space-y-2">
