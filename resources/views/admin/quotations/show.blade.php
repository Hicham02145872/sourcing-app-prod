                                    ...
                                    <div class="space-y-2">
                                        @foreach($quotation->sourcingRequest->destinations as $dest)
                                            <div class="flex items-start gap-2 p-2 bg-slate-50 rounded-lg">
                                                <div class="h-6 w-6 rounded bg-slate-100 flex items-center justify-center text-slate-400 mt-0.5 shrink-0">
                                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                                </div>
                                                <div class="min-w-0">
                                                    <p class="text-xs font-bold text-slate-700">{{ $dest->country->name }}</p>
                                                    <p class="text-[11px] text-slate-500 leading-tight">{{ $dest->label_address ?: $dest->address }}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
