                ...
                <div class="lg:col-span-2 space-y-6">
                                ...
                                @if ($sourcingRequest->canTransitionTo($status, auth()->user()))
                                    <form action="{{ route('admin.sourcing-requests.update-status', $sourcingRequest) }}" method="POST" class="w-full">
                                        ...
                                        <button type="submit" 
                                                ...
                                                class="w-full px-3 py-2.5 bg-white dark:bg-slate-800 hover:bg-violet-50 dark:hover:bg-violet-900/20 text-slate-900 dark:text-white font-semibold rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col items-center justify-center gap-1.5 group text-xs">
                                            @php
                                                $btnConfig = [
                                                    'pending' => ['color' => 'amber', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
                                                    'active' => ['color' => 'emerald', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
                                            ...
                                            @endphp
                                            <div class="w-8 h-8 rounded-lg flex items-center justify-center {{ "bg-{$btnData['color']}-100 dark:bg-{$btnData['color']}-900/30 text-{$btnData['color']}-600 dark:text-{$btnData['color']}-400" }} group-hover:scale-110 transition-transform">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="{{ $sourcingRequest->product_url }}" target="_blank" 
                                       class="inline-flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-900/20 dark:to-blue-900/10 hover:from-blue-100 dark:hover:from-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg border border-blue-200 dark:border-blue-700/50 transition-all duration-200 w-full group shadow-sm hover:shadow-md">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <span class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-semibold bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-400 border border-violet-200 dark:border-violet-700 capitalize">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <span class="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold 
                                        {{ $sourcingRequest->shipping_method === 'air' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-700' : 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-700' }}">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                        ...
                        <div class="p-6 space-y-3">
                            {{-- Phone Number --}}
                            <div class="flex items-center justify-between py-3 px-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-600">
