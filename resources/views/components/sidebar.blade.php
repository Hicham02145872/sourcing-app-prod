    ...
    <div class="border-t border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-900 mt-auto">
        @if($role === 'client')
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-3 mb-3 shadow-sm hover:shadow-md transition-all duration-200 group">
                <a href="https://wa.me/{{ $socialMediaLinks->whatsapp_number }}?text={{ urlencode($socialMediaLinks->whatsapp_message ?? 'Hello, I would like to inquire about...') }}" target="_blank" class="flex items-center gap-3 text-white hover:text-white transition-colors">
