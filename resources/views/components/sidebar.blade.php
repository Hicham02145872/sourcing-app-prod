        ...
        <nav class="px-3 py-4">
            ...
            @else
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.welcome-content.index') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.welcome-content.index') ? 'bg-[#EF7722] dark:bg-[#EF7722] text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:bg-[#FAA533]/10 dark:hover:bg-[#FAA533]/10 hover:translate-x-1' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
