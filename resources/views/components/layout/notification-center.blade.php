    ...
    <div class="relative">
        <button @click="open = !open; if(open) fetchNotifications()" 
            ...
            <span x-show="unreadCount > 0" 
                  class="absolute top-2 end-2 flex h-2.5 w-2.5">
        ...
        <div x-show="open" 
             ...
             class="absolute end-0 mt-3 w-screen max-w-[440px] bg-white dark:bg-slate-900 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-slate-200 dark:border-slate-800 overflow-hidden z-50 ring-1 ring-slate-200/50 dark:ring-slate-800/50"
             style="display: none;">
