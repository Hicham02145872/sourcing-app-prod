...
<div class="relative" x-data="{ open: false }">
    ...
    <div x-show="open" 
         ...
         class="absolute right-0 mt-3 w-56 bg-white dark:bg-slate-900 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-slate-200 dark:border-slate-800 overflow-hidden z-50 ring-1 ring-slate-200/50 dark:ring-slate-800/50" 
         style="display: none;">
