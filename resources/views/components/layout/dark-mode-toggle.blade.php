...
<div x-data="{
    ...
    <button @click="toggleTheme()" 
            class="relative p-2.5 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-200 focus:outline-none group overflow-hidden">
