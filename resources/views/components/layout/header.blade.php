    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-3">
                {{-- Social Media Icons Modernisées --}}
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" 
                   class="p-2.5 text-gray-600 dark:text-gray-400 hover:text-[#1877F2] hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 group" 
                   title="Facebook">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" 
                   class="p-2.5 text-gray-600 dark:text-gray-400 hover:text-[#E4405F] hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 group" 
                   title="Instagram">
                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" 
                   class="p-2.5 text-gray-600 dark:text-gray-400 hover:text-[#0A66C2] hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 group" 
                   title="LinkedIn">
                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" 
                   class="p-2.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 group" 
                   title="Twitter">
                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
