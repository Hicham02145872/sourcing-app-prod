...
class QuotationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'quality_options.low.weight' => 'required_with:quality_options.low.price|numeric|min:0',
            'quality_options.medium.weight' => 'required_with:quality_options.medium.price|numeric|min:0',
            'quality_options.good.weight' => 'required_with:quality_options.good.price|numeric|min:0',
            'quality_options.low.weight_unit' => 'required_with:quality_options.low.weight|string|in:g,kg,colis',
            'quality_options.medium.weight_unit' => 'required_with:quality_options.medium.weight|string|in:g,kg,colis',
            'quality_options.good.weight_unit' => 'required_with:quality_options.good.weight|string|in:g,kg,colis',
