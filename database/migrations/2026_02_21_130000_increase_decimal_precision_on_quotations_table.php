...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('quotations', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('quotations', 'unit_price')) {
                $table->decimal('unit_price', 15, 2)->nullable()->change();
            }
            if (Schema::hasColumn('quotations', 'commission_service')) {
                $table->decimal('commission_service', 15, 2)->nullable()->change();
            }
            if (Schema::hasColumn('quotations', 'unit_weight')) {
                $table->decimal('unit_weight', 15, 2)->nullable()->change();
            }
            if (Schema::hasColumn('quotations', 'delivery_cost_china')) {
